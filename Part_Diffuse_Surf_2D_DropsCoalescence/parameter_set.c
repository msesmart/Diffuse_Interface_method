...
double dt=5.0E-5;    // the least step time
long ioutput=1;  //output file every ioutput*dt
long iteration=0,iterationnumber=100;
...
//double rad,xc,yc;
double rad1,rad2,xc1,xc2,yc1,yc2;
...
double fi[l+1][m+1],fin[l+1][m+1],fio[l+1][m+1],source[l+1][m+1];
...
void parameter_initial(void)
{
	...
	adv=90.0;rec=adv;
	rad1=1.0; xc1=1.5; yc1=2.0;
	rad2=1.0; xc2=3.494; yc2=2.0;
