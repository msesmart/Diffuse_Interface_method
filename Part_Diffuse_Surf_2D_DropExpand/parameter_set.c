...
long iteration=0,iterationnumber=25000;
...
double fi[l+1][m+1],fin[l+1][m+1],fio[l+1][m+1];
double curv[l+1][m+1];//curvature
double nor_vector_x[l+1][m+1],nor_vector_y[l+1][m+1];/* unit normal vector */
...
void parameter_initial(void)
{
	...
	adv=90.0;rec=adv;
	rad=0.3; xc=3.0; yc=3.0;
	Pe_surf=10.0; /* Pe for surfactant */
	surf_elas=0.3; surf_cove=0.3;
	delta_mini=0.01;
	...
	pdr=0.2*dx; pdr_min=0.5*pdr; pdr_max=1.2*pdr;
}
